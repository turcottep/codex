  ...
  return (
    ...
    <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
      <div className="pl-4 flex items-center">
        <a className="toggleColour text-black no-underline hover:no-underline font-bold text-2xl sm:text-4xl" href="#">
          SALSA
        </a>
      </div>
      ...
      <div className="w-full flex-grow sm:flex sm:items-center sm:w-auto hidden mt-2 sm:mt-0 bg-white sm:bg-transparent text-black p-4 sm:p-0 z-20" id="nav-content">
        ...
        <button
          id="navAction"
          className="mx-auto sm:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 sm:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
        >
          Subscribe
        </button>
      </div>
