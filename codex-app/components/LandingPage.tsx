...
export default function LandingPage() {
  return (
    <div
      className="md:pt-24 bg-red-200 h-full bg-cover bg-top md:bg-right md:bg-50% bg-no-repeat bg-fixed"
      style={{
        backgroundImage: "url('./nourriture_spaced.svg')",
      }}
    >
      <div className="h-full container justify-evenly px-3 2xl:px-10 lg:mx-auto flex flex-col items-center">
        ...
        <div className="md:self-start min-w-0 min-h-0 w-full sm:mx-0 md:w-2/5 lg:w-1/2">
          <NameForm />
        </div>
      </div>
    </div>
